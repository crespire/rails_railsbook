...
This is my implementation of basic Facebook functionality leveraging Rails 7 and its assocaited technologies. This application includes:
* Friends and requests
* Posts and comments with ActionText powering the attachments via ActiveStorage and Amazon S3.
* Notifications
* Likes
* User authentication and Omniauth through the devise gem
...
* Users created from omniauth are currently not able to edit their profiles. This is a pretty big deal, especially if they want to add supplementary information. Work to fix this would involve modifying the User model and making some changes to the Devise omniauth flow, then updating my edit user flow to accomodate these changes.
